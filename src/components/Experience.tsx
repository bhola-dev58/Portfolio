                        ...
                        {experiences.map((exp, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Spacer for alternating column */}
                                    <div className="hidden md:block md:w-1/2" />

                                    {/* Card */}
                                    <div className="md:w-1/2 ml-16 md:ml-0">
                                        <Card className="p-6 card-shadow bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/50 hover:shadow-primary/10 hover:shadow-lg transition-all duration-300 group">
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <h3 className="text-lg md:text-xl font-bold text-foreground mb-1 break-words group-hover:text-primary transition-colors">
                                                        {exp.title}
                                                    </h3>
